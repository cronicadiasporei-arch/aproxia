...
class _InstallPageBodyState extends State<_InstallPageBody>
  ...
  final RxBool autostart = true.obs;
  ...
  final buttonStyle = ButtonStyle(
    ...
    side:
        const MaterialStatePropertyAll(BorderSide(color: AproxiaBrand.border)),
        ...
        child: Row(
          children: [
            Obx(() => Checkbox(
                  ...
                  onChanged: (_) =>
                      btnEnabled.value ? value.value = !value.value : null,
                )),
          ...
          child: ConstrainedBox(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      color: AproxiaBrand.ink.withOpacity(.07),
                      blurRadius: 28,
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4),
                            Text(
                                'Instalarea permite acces complet la distanță, inclusiv prin ferestrele Windows UAC.',
                                style: TextStyle(
                                    fontSize: 13, color: AproxiaBrand.muted)),
                          ],
                        ),
                      ),
                    ],
                  ...
                  option(autostart, 'Pornește automat odată cu Windows'),
                    ...
                    child: const Row(
                      ...
                      children: [
                        Icon(Icons.info_outline_rounded,
                            color: AproxiaBrand.accent, size: 22),
                        SizedBox(width: 10),
                        Expanded(
                          child: Text(
  ...
  void install() {
    ...
    if (autostart.value) args += ' autostart';
